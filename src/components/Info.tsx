        ...
        <div className={classes.mainContainer}>
            ...
            <div className={classes.hero}>
                ...
                <div className={classes.info}>
                    ...
                    <ul>
                        <li>
                            זכותו של הילד לקשר משמעותי עם שני הוריו גם אם אינם
                            נשואים זה לזה.
                        </li>
                        <li>
                            נשיאה משותפת באחריות הורית וכלכלית לילד, בכך ששני
                    ...
                    <div>
                        ...
                        לתהליך. ההסכם יכול להתקיים בין כל שני הורים ביולוגיים,
