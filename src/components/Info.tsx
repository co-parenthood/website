            ...
            <div className={classes.hero}>
                ...
                <div className={classes.info}>
                    ...
                    <div>
                        ...
                        לתהליך. ההסכם יכול להתקיים בין הורים שיש ביניהם אמון
                        ומערכת יחסים מינימלית לגידול משותף של ילד, גם אם הם
                        רשומים פורמלית כרווקים, או גרושים. ההסכם, שנחתם לרוב
                        טרום הולדת הילד, כולל הסדרה והתייחסות לתחומים הקשורים
                        להריון, טיפולי פוריות, חלוקת אחריות כלכלית, חלוקת ימי
                        טיפול בילד וסוגיות כמו חינוך, הסעות ועוד.
                    </div>
